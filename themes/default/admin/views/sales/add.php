...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#gift_card_no', function () {
         ...
         $('#add_item').bind('focus', function (e) {
            
            $(this).autocomplete("search",' ');
                
        });

        $(document).on('ifChanged','.category_id',function(){
            $('#add_item').blur();
            // alert('test');
        });

        // $(document).on("ifChanged",'#add_item',function(){
        //     alert('test');
        // });

        $(document).on('click',function(e){
            if ($(e.target).hasClass("add_item") == false) {
                $("#add_item").blur();
            }
          // alert('test');
        });
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="col-md-3">
                                        <input type="radio" name="category_id" id="category_id" class="form-control category_id" checked=""> &nbsp; <?php echo "ទាំងអស់"; ?>
                                    </div>
                                <?php foreach ($categories as $key => $value) {
                                
                                 ?>
                                    <div class="col-md-3">
                                        <input type="radio" name="category_id" id="category_id" class="form-control category_id" value="<?php echo $value->id;?>">
                                        &nbsp;
                                        <?php echo $value->name; ?>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg add_item" id="add_item" placeholder="' . lang("add_product_to_order") . '"'); ?>
