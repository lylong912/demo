...
<head>
    ...
    <link rel="alternate" href="<?php echo $assets ?>css/khmerfonts.css">
...
<div id="app_wrapper">
                    ...
                    <?php if (($Owner || $Admin || $GP['reports-quantity_alerts'] || $GP['reports-expiry_alerts']) && ($qty_alert_num > 0 || $exp_alert_num > 0 || $shop_sale_alerts)) { ?>
                        <li class="dropdown hidden-sm">
                            <a class="btn blightOrange tip" title="<?= lang('alerts') ?>"
                                ...
                                <span class="number bred black"><?= $qty_alert_num+(($Settings->product_expiry) ? $exp_alert_num : 0)+$shop_sale_alerts+$shop_payment_alerts+($payment_alert_num[0]->cus_qty); ?></span>
                            </a>
                            <ul class="dropdown-menu pull-right">
                                <li>
                                ...
                                <li>
                                    <a href="<?= admin_url('reports/sale_payment_term') ?>" class="">
                                        <span class="label label-danger pull-right" style="margin-top:3px;"><?= $payment_alert_num[0]->cus_qty; ?></span>
                                        <span style="padding-right: 35px;"><?= lang('Payment alert') ?></span>
                                    </a>
                                </li>
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_quantity_adjustments" class="hide">
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <li id="sales_deliveries" class="hide">
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    ...
                                    <li id="purchases_add_expense" class="">
                                        <a class="submenu" href="<?= admin_url('purchases/add_expense_type'); ?>" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_expense_type'); ?></span>
                                        </a>
                                    </li>
                                    <li id="purchases_add_expense" class="">
                                        <a class="submenu" href="<?= admin_url('purchases/list_expense_type'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('List_Expense_Type'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>

                            <li class="mm_transfers hide">
                                <a class="dropmenu" href="#">
                            ...
                            <li class="mm_auth mm_customers mm_suppliers mm_billers">
                                ...
                                <ul>
                                    ...
                                    <li id="billers_index" class="hide">
                                    ...
                                    <li id="customers_index">
                                        <a class="submenu" href="<?= admin_url('customers'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> <?= lang('list_customer'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="customers_index" class="hide">
                                        <a class="submenu" href="<?= admin_url('customers/list_table'); ?>">
                                            <i class="fa fa-users"></i><span class="text"> <?= lang('list_table'); ?></span>
                                        </a>
                                    </li>
                                    <li id="customers_index" class="hide">
                                        <a class="submenu" href="<?= admin_url('customers/add_table'); ?>" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('add_table'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="suppliers_index" class="hide">
                            ...
                            <?php if ($Owner) { ?>
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        ...
                                        <li id="system_settings_expense_categories" class="hide">
                                        ...
                                        <li id="system_settings_tax_rates" class="hide">
                                        ...
                                        <li id="system_settings_email_templates" class="hide">
    ...
    <!-- ====================edit report======================================= -->
                        <li class="report">
                            <a href="#" class="dropmenu">
                                ...
                                <span><?= lang('Custom_report');?></span>
                                <span class="chevron closed"></span>
                            </a>
                            <ul>
                               <li id="register_report">
                                   <a href="<?php echo base_url('admin/reports/register');?>">
                                       <i class="fa fa-bars"></i><span><?=lang('Register_report');?></span>
                                   </a>
                               </li> 
                               <li id="dialy_salse">
                                   <a href="<?php echo base_url('admin/reports/daily_sales');?>">
                                       <i class="fa fa-calendar-o"></i><span><?=lang('Daily_sale');?></span>
                                   </a>
                               </li>
                               <li id="expense_report">
                                   <a href="<?php echo base_url('admin/reports/expanses_report');?>">
                                       <i class="fa fa-bars"></i><span><?= lang('expense_report');?></span>
                                   </a>
                               </li>
                               <li id="purchases_report">
                                   <a href="<?php echo base_url('admin/reports/mypurchase_report');?>">
                                       <i class="fa fa-building"></i><span><?= lang('purchases_report');?></span>
                                   </a>
                               </li>
                               <li id="sales_report">
                                   <a href="<?php echo base_url('admin/reports/mysale_report');?>">
                                       <i class="fa fa-barcode"></i><span><?= lang('Sales_report');?></span>
                                   </a>
                               </li>
                               <li id="reports_myproductcategories_report">
                                   <a href="<?php echo base_url('admin/reports/myproductcategories_report');?>">
                               ...
                               <li id="profit_loss" >
                                ...
                                <li id="account_pay">
                                       <a href="<?php echo base_url('admin/reports/customeers_transaction');?>">
                                ...
                                <li id="account_pay" >
                                       <a href="<?php echo base_url('admin/reports/stock_detReport');?>">
                                           <i class="fa fa-money"></i><span><?= lang('Stock In / Out Report');?></span>
                                       </a>
                                </li>
                                <li id="account_pay" class = "hide">
                                       <a href="<?php echo base_url('admin/reports/spoiled_report');?>">
                                           <i class="fa fa-money"></i><span><?= lang('Spoiled Report');?></span>
                                       </a>
                                </li>
                                <li id="cus_cre_Cash" >
                                       <a href="<?php echo base_url('admin/reports/customerCashCredit');?>">
    ...
    <!-- =========================end edit report================================ -->
                            <!-- <li class="mm_reports">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <span class="text"> <?= lang('Custom_report'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                     <li id="home">
                                        <a href="<?= admin_url('reports') ?>">
                                            <i class="fa fa-bars"></i><span class="text"> <?= lang('test'); ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    ...
                                    <?php } ?>
                                    <?php if ($GP['sum_purchases_payment']) { ?>
                                     <li id="purchases_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/clear_payment'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('purchases_payment'); ?></span>
                                        </a>
                                    ...
                                    <?php } ?>
                                    <?php if ($GP['list_purchases_payment']) { ?>\
                                    <li id="view_purchases_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/print_payment'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('view_purchases_payment'); ?></span>
                                        </a>
                                    ...
                                    <?php } ?>
                                    <?php if ($GP['add-purchases-expenses']) { ?>
                            ...
                            <?php } ?>
                              ...
                              <?php if ($GP['reports-register_report'] || $GP['reports-daily_sales'] || $GP['reports-expenses'] || $GP['reports-purchases'] || $GP['reports-sales'] || $GP['reports-products'] ||$GP['reports-warehouse_chat'] || $GP['reports-profit_and_loss']) { ?>
                                ...
                                <ul>
                                 <?php if ($GP['reports-register_report']) { ?>
                                   <li id="register_report">
                                       <a href="<?php echo base_url('admin/reports/register');?>">
                                           <i class="fa fa-bars"></i><span><?=lang('Register_report');?></span>
                                       </a>
                                ...
                                <?php if ($GP['reports-sales']) { ?>
                                   <li id="sales_report">
                                       <a href="<?php echo admin_url('reports/mysale_report');?>">
                                           <i class="fa fa-barcode"></i><span><?= lang('Sales_report');?></span>
                                       </a>
                                   </li>
                                <?php } ?>
                                <?php if ($GP['reports-products']) { ?>
                                   <li id="product_report">
                                       <a href="<?php echo base_url('admin/reports/myproductcategories_report');?>">
                                           <i class="fa fa-barcode"></i><span><?= lang('Product_Report');?></span>
                                       </a>
                                   </li>
                                <?php } ?>
                                <?php if ($GP['reports-stock_in_out_report']) { ?>
                                   <li id="stock_in_out">
                                       <a href="<?php echo base_url('admin/reports/inventory_report');?>">
                                           <i class="fa fa-barcode"></i><span><?=lang('Stock In/Out_Report');?></span>
                                       </a>
                                   </li>
                                <?php } ?>
                                <?php if ($GP['reports-warehouse_chat']) { ?>
                                ...
                                <?php } ?>
                                <?php if ($GP['reports-profit_and_loss']) { ?>
