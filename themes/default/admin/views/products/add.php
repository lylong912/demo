    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                <!-- , 'digital' => lang('digital'), , 'combo' => lang('combo'), 'service' => lang('service') -->
                    ...
                    <div class="form-group">
                        ...
                        foreach ($location as $locations) {
                            $lo[$locations->id] = $locations->name;
                        }
                        // var_dump($location);
                        echo form_dropdown('location', $lo, (isset($_POST['location']) ? $_POST['location'] : ($product ? $product->location : '')), 'class="form-control select" id="location" placeholder="' . lang("select") . " " . lang("location") . '" style="width:100%"')
                        ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <?php } ?>
                    <div class="form-group standard hide ">
                            ...
                            <div class="controls table-controls">
                                <table id="prTable"
                                    ...
                                    <tr>
                                        ...
                                        <th class="hide" class="col-md-3 col-sm-3 col-xs-3"><?= lang("unit_price"); ?></th>
    ...
    $(document).ready(function () {
        ...
        function add_product_item(item) {
            ...
            $.each(items, function () {
                ...
                tr_html += '<td class="hide"><input class="form-control text-center rprice" name="combo_item_price[]" type="text" value="' + formatDecimal(this.price) + '" data-id="' + row_no + '" data-item="' + this.id + '" id="combo_item_price_' + row_no + '" onClick="this.select();"></td>';
